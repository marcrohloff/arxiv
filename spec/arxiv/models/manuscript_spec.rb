  ...
  describe Manuscript do
    ...
    describe "content_types" do
      it "return an array of available content_types" do
        expect(manuscript.content_types).to include("text/html", "application/pdf")
        expect(manuscript.content_types.size).to eq 2
      end
    end
    ...
    describe "pdf_url" do
      it "should return the url to download the manuscript in PDF format" do
        expect(manuscript.pdf_url).to eq 'http://arxiv.org/pdf/1202.0819v1.pdf'
      end
    end
    ...
    describe "primary_category" do
      it "should description return the manuscript's primary category" do
        expect(manuscript.primary_category.abbreviation).to eq "astro-ph.IM"
      end
    end
